...
const styles = [
    ...
    'third-party/golden-layout/goldenlayout-base.css',
    'third-party/golden-layout/goldenlayout-dark-theme.css'
];

const scripts = [
    'third-party/golden-layout/goldenlayout.min.js',
    'third-party/terser/bundle.min.js',
    'third-party/less/less.min.js'
];

const requireScript = 'third-party/monaco-editor/min/vs/loader.js';
